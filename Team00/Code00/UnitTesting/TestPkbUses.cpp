...
public:
  ...
  TEST_METHOD(UsesLineNumberAndString) {
    Assert::IsTrue(setUpTests.pkb.uses(setUpTests.c4, setUpTests.strx));
    Assert::IsTrue(setUpTests.pkb.uses(setUpTests.c4, setUpTests.stry));

    Assert::IsTrue(setUpTests.pkb.uses(
        setUpTests.c11, setUpTests.strq)); // used in call procedure

    Assert::IsFalse(setUpTests.pkb.uses(
        setUpTests.c11,
        setUpTests.stry)); // call procedure doesnt use input var
    Assert::IsFalse(
        setUpTests.pkb.uses(setUpTests.c2, setUpTests.stry)); // line doesnt use
    Assert::IsFalse(setUpTests.pkb.uses(setUpTests.c4,
                                        setUpTests.strr)); // incorrect var used
  } // namespace UnitTesting

  TEST_METHOD(UsesLineNumberAndVariable) {

    Assert::IsTrue(setUpTests.pkb.uses(setUpTests.c4, setUpTests.variable) ==
                   STRING_SET{"x", "y"}); // on assign statement
    Assert::IsTrue(setUpTests.pkb.uses(setUpTests.c3, setUpTests.variable) ==
                   STRING_SET{"x", "y"}); // on while statement
    Assert::IsTrue(setUpTests.pkb.uses(setUpTests.c7, setUpTests.variable) ==
  ...
  TEST_METHOD(UsesStmtAndString) {
    ...
    Assert::IsTrue(setUpTests.pkb.uses(setUpTests.stmt, setUpTests.stry) ==
                   STRING_SET{setUpTests.l3, setUpTests.l4, setUpTests.l7});
    Assert::IsTrue(setUpTests.pkb.uses(setUpTests.stmt, setUpTests.strr) ==
                   STRING_SET{setUpTests.l10});

    Assert::IsTrue(setUpTests.pkb.uses(setUpTests.stmt, setUpTests.strm) ==
  ...
  TEST_METHOD(UsesStmtAndVariable) {
    ...
    Assert::IsTrue(
        setUpTests.pkb.uses(setUpTests.stmt, setUpTests.variable) ==
        STRING_PAIRS{
            STRING_VECTOR{
  ...
  TEST_METHOD(UsesStmtAndUnderscore) {
    ...
    Assert::IsTrue(
        setUpTests.pkb.uses(setUpTests.stmt, setUpTests.underscore) ==
  ...
  TEST_METHOD(UsesStatementAndString) {
    ...
    Assert::IsTrue(setUpTests.pkb.uses(setUpTests.a, setUpTests.strx) ==
                   STRING_SET{setUpTests.l4, setUpTests.l10});
    Assert::IsTrue(setUpTests.pkb.uses(setUpTests.w, setUpTests.strt) ==
                   STRING_SET{setUpTests.l14, setUpTests.l17});
    Assert::IsTrue(setUpTests.pkb.uses(setUpTests.c, setUpTests.strx) ==
  ...
  TEST_METHOD(UsesStatementAndVariable) {
    ...
    Assert::IsTrue(
        setUpTests.pkb.uses(setUpTests.a, setUpTests.variable) ==
  ...
  TEST_METHOD(UsesStatementAndUnderscore) {
    ...
    Assert::IsTrue(setUpTests.pkb.uses(setUpTests.w, setUpTests.underscore) ==
  ...
  TEST_METHOD(UsesStringAndString) {
    ...
    Assert::IsTrue(setUpTests.pkb.uses(setUpTests.strpmain,
  ...
  TEST_METHOD(UsesStringAndVariable) {
    ...
    Assert::IsTrue(
        setUpTests.pkb.uses(setUpTests.strpaux, setUpTests.variable) ==
        STRING_SET{"x", "y"}); // no calls, only vars used directly
    Assert::IsTrue(
        setUpTests.pkb.uses(setUpTests.strpmain, setUpTests.variable) ==
  ...
  TEST_METHOD(UsesStringAndUnderscore) {
    ...
    Assert::IsTrue(
        setUpTests.pkb.uses(setUpTests.strpaux, setUpTests.underscore));
    Assert::IsTrue(
        setUpTests.pkb.uses(setUpTests.strpextra, setUpTests.underscore));
    Assert::IsTrue(
        setUpTests.pkb.uses(setUpTests.strpmain, setUpTests.underscore));
    Assert::IsTrue(
        setUpTests.pkb.uses(setUpTests.strpcomplicate, setUpTests.underscore));

  } // namespace UnitTesting

  TEST_METHOD(UsesProcedureAndString) {

    Assert::IsTrue(setUpTests.pkb.uses(setUpTests.procedure, setUpTests.strx) ==
                   STRING_SET{"aux", "main"});
    Assert::IsTrue(setUpTests.pkb.uses(setUpTests.procedure, setUpTests.strk) ==
  ...
  TEST_METHOD(UsesProcedureAndVariable) {
    ...
    Assert::IsTrue(
        setUpTests.pkb.uses(setUpTests.procedure, setUpTests.variable) ==
  ...
  TEST_METHOD(UsesProcedureAndUnderscore) {
    ...
    Assert::IsTrue(
        setUpTests.pkb.uses(setUpTests.procedure, setUpTests.underscore) ==
