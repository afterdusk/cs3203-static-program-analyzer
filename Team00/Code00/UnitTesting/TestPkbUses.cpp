...
public:
  ...
  TEST_METHOD(UsesLineNumberAndString) {
    Assert::IsTrue(pkbQueryInterface.uses(setUpTests.c4, setUpTests.strx));
    Assert::IsTrue(pkbQueryInterface.uses(setUpTests.c4, setUpTests.stry));
    ...
    Assert::IsFalse(pkbQueryInterface.uses(setUpTests.c2,
                                           setUpTests.stry)); // line doesnt use
    Assert::IsFalse(
        pkbQueryInterface.uses(setUpTests.c4,
                               setUpTests.strr)); // incorrect var used
  }                                               // namespace UnitTesting

  TEST_METHOD(UsesLineNumberAndVariable) {

    Assert::IsTrue(pkbQueryInterface.uses(setUpTests.c4, setUpTests.variable) ==
                   STRING_SET{"x", "y"}); // on assign statement
    Assert::IsTrue(pkbQueryInterface.uses(setUpTests.c3, setUpTests.variable) ==
                   STRING_SET{"x", "y"}); // on while statement
    Assert::IsTrue(pkbQueryInterface.uses(setUpTests.c7, setUpTests.variable) ==
  ...
  TEST_METHOD(UsesStmtAndString) {
    ...
    Assert::IsTrue(pkbQueryInterface.uses(setUpTests.stmt, setUpTests.stry) ==
                   STRING_SET{setUpTests.l3, setUpTests.l4, setUpTests.l7});
    Assert::IsTrue(pkbQueryInterface.uses(setUpTests.stmt, setUpTests.strr) ==
                   STRING_SET{setUpTests.l10});

    Assert::IsTrue(pkbQueryInterface.uses(setUpTests.stmt, setUpTests.strm) ==
  ...
  TEST_METHOD(UsesStmtAndVariable) {
    ...
    Assert::IsTrue(
        pkbQueryInterface.uses(setUpTests.stmt, setUpTests.variable) ==
        STRING_PAIRS{
            STRING_VECTOR{
  ...
  TEST_METHOD(UsesStmtAndUnderscore) {
    ...
    Assert::IsTrue(
        pkbQueryInterface.uses(setUpTests.stmt, setUpTests.underscore) ==
  ...
  TEST_METHOD(UsesStatementAndString) {
    ...
    Assert::IsTrue(pkbQueryInterface.uses(setUpTests.a, setUpTests.strx) ==
                   STRING_SET{setUpTests.l4, setUpTests.l10});
    Assert::IsTrue(pkbQueryInterface.uses(setUpTests.w, setUpTests.strt) ==
                   STRING_SET{setUpTests.l14, setUpTests.l17});
    Assert::IsTrue(pkbQueryInterface.uses(setUpTests.c, setUpTests.strx) ==
  ...
  TEST_METHOD(UsesStatementAndVariable) {
    ...
    Assert::IsTrue(
        pkbQueryInterface.uses(setUpTests.a, setUpTests.variable) ==
  ...
  TEST_METHOD(UsesStatementAndUnderscore) {
    ...
    Assert::IsTrue(
        pkbQueryInterface.uses(setUpTests.w, setUpTests.underscore) ==
  ...
  TEST_METHOD(UsesStringAndString) {
    ...
    Assert::IsTrue(
        pkbQueryInterface.uses(setUpTests.strpmain,
  ...
  TEST_METHOD(UsesStringAndVariable) {
    ...
    Assert::IsTrue(
        pkbQueryInterface.uses(setUpTests.strpaux, setUpTests.variable) ==
        STRING_SET{"x", "y"}); // no calls, only vars used directly
    Assert::IsTrue(
        pkbQueryInterface.uses(setUpTests.strpmain, setUpTests.variable) ==
  ...
  TEST_METHOD(UsesStringAndUnderscore) {
    ...
    Assert::IsTrue(
        pkbQueryInterface.uses(setUpTests.strpaux, setUpTests.underscore));
    Assert::IsTrue(
        pkbQueryInterface.uses(setUpTests.strpextra, setUpTests.underscore));
    Assert::IsTrue(
        pkbQueryInterface.uses(setUpTests.strpmain, setUpTests.underscore));
    Assert::IsTrue(pkbQueryInterface.uses(setUpTests.strpcomplicate,
  ...
  TEST_METHOD(UsesProcedureAndString) {
    ...
    Assert::IsTrue(
        pkbQueryInterface.uses(setUpTests.procedure, setUpTests.strx) ==
        STRING_SET{"aux", "main"});
    Assert::IsTrue(
        pkbQueryInterface.uses(setUpTests.procedure, setUpTests.strk) ==
  ...
  TEST_METHOD(UsesProcedureAndVariable) {
    ...
    Assert::IsTrue(
        pkbQueryInterface.uses(setUpTests.procedure, setUpTests.variable) ==
  ...
  TEST_METHOD(UsesProcedureAndUnderscore) {
    ...
    Assert::IsTrue(
        pkbQueryInterface.uses(setUpTests.procedure, setUpTests.underscore) ==
