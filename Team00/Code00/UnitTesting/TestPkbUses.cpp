...
public:
  ...
  TEST_METHOD(UsesLineNumberAndVariable) {
    ...
    Assert::IsTrue(setUpTests.pkbQueryInterface->uses(setUpTests.c4,
                                                      setUpTests.variable) ==
                   STRING_SET{"x", "y"}); // on assign statement
    Assert::IsTrue(setUpTests.pkbQueryInterface->uses(setUpTests.c3,
                                                      setUpTests.variable) ==
                   STRING_SET{"x", "y"}); // on while statement
    Assert::IsTrue(setUpTests.pkbQueryInterface->uses(setUpTests.c7,
                                                      setUpTests.variable) ==
