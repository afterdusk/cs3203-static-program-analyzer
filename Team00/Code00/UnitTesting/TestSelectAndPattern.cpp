...
public:
  ...
  TEST_METHOD(SelectVariable) {
    Assert::IsTrue(pkbQueryInterface.select(setUpTests.variable) ==
                   STRING_SET{"x", "y", "r", "m", "q", "t", "k"});
  } // namespace UnitTesting

  TEST_METHOD(SelectProcedure) {
    Assert::IsTrue(pkbQueryInterface.select(setUpTests.procedure) ==
                   STRING_SET{"main", "aux", "extra", "complicate"});
  } // namespace UnitTesting

  TEST_METHOD(SelectStatement) {
    Assert::IsTrue(pkbQueryInterface.select(setUpTests.r) ==
                   STRING_SET{setUpTests.l1, setUpTests.l2, setUpTests.l8,
                              setUpTests.l9, setUpTests.l12, setUpTests.l13,
                              setUpTests.l5});
    Assert::IsTrue(pkbQueryInterface.select(setUpTests.c) ==
                   STRING_SET{setUpTests.l7, setUpTests.l11, setUpTests.l25});
    Assert::IsTrue(pkbQueryInterface.select(setUpTests.stmt) ==
  ...
  TEST_METHOD(SelectConstant) {
    Assert::IsTrue(
        pkbQueryInterface.select(setUpTests.constant) ==
  ...
  TEST_METHOD(Match) {
     ...
     */
    // complete match
    Assert::IsTrue(pkbQueryInterface.match(setUpTests.a, varq, spec1) ==
                   STRING_SET{setUpTests.l20, setUpTests.l24});

    // partial match
    Assert::IsTrue(pkbQueryInterface.match(setUpTests.a, vary, spec2) ==
                   STRING_SET{setUpTests.l4});
    Assert::IsTrue(pkbQueryInterface.match(setUpTests.a, varq, spec3) ==
    ...
    // complete match
    Assert::IsTrue(
        pkbQueryInterface.match(setUpTests.a, setUpTests.underscore, spec1) ==
        STRING_SET{setUpTests.l20, setUpTests.l24});

    // partial match
    Assert::IsTrue(
        pkbQueryInterface.match(setUpTests.a, setUpTests.underscore, spec2) ==
        STRING_SET{setUpTests.l4, setUpTests.l10});
    Assert::IsTrue(
        pkbQueryInterface.match(setUpTests.a, setUpTests.underscore, spec3) ==
    ...
    // complete match
    Assert::IsTrue(
        pkbQueryInterface.match(setUpTests.a, setUpTests.variable, spec1) ==
        STRING_PAIRS(STRING_VECTOR{setUpTests.l24, setUpTests.l20},
                     STRING_VECTOR{"q", "q"}));

    // partial match
    Assert::IsTrue(
        pkbQueryInterface.match(setUpTests.a, setUpTests.variable, spec2) ==
        STRING_PAIRS(STRING_VECTOR{setUpTests.l4, setUpTests.l10},
                     STRING_VECTOR{"y", "m"}));
    Assert::IsTrue(
        pkbQueryInterface.match(setUpTests.a, setUpTests.variable, spec3) ==
