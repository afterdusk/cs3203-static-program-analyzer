...
public:
  ...
  TEST_METHOD(ModifiesLineNumberAndString) {
    ...
    Assert::IsTrue(
        pkbQueryInterface.modifies(setUpTests.c5,
  ...
  TEST_METHOD(ModifiesLineNumberAndVariable) {
    ...
    Assert::IsTrue(
        pkbQueryInterface.modifies(setUpTests.c4, setUpTests.variable) ==
        STRING_SET{"y"}); // on assign statement
    Assert::IsTrue(
        pkbQueryInterface.modifies(setUpTests.c14, setUpTests.variable) ==
        STRING_SET{"q", "t"}); // on while statement
    Assert::IsTrue(
        pkbQueryInterface.modifies(setUpTests.c7, setUpTests.variable) ==
  ...
  TEST_METHOD(ModifiesStmtAndString) {
    ...
    Assert::IsTrue(
        pkbQueryInterface.modifies(setUpTests.stmt, setUpTests.strm) ==
        STRING_SET{setUpTests.l10});
    Assert::IsTrue(
        pkbQueryInterface.modifies(setUpTests.stmt, setUpTests.strx) ==
        STRING_SET{setUpTests.l1, setUpTests.l7, setUpTests.l8});

    Assert::IsTrue(
        pkbQueryInterface.modifies(setUpTests.stmt, setUpTests.strk) ==
  ...
  TEST_METHOD(ModifiesStmtAndVariable) {
    ...
    Assert::IsTrue(
        pkbQueryInterface.modifies(setUpTests.stmt, setUpTests.variable) ==
        STRING_PAIRS{
            STRING_VECTOR{
  ...
  TEST_METHOD(ModifiesStmtAndUnderscore) {
    ...
    Assert::IsTrue(
        pkbQueryInterface.modifies(setUpTests.stmt, setUpTests.underscore) ==
  ...
  TEST_METHOD(ModifiesStatementAndString) {
    ...
    Assert::IsTrue(pkbQueryInterface.modifies(setUpTests.a, setUpTests.strx) ==
                   STRING_SET{}); // no assignment modifies var x
    Assert::IsTrue(pkbQueryInterface.modifies(setUpTests.w, setUpTests.strt) ==
                   STRING_SET{setUpTests.l14, setUpTests.l17});
    Assert::IsTrue(pkbQueryInterface.modifies(setUpTests.c, setUpTests.strx) ==
  ...
  TEST_METHOD(ModifiesStatementAndVariable) {
    ...
    Assert::IsTrue(
        pkbQueryInterface.modifies(setUpTests.a, setUpTests.variable) ==
  ...
  TEST_METHOD(ModifiesStatementAndUnderscore) {
    ...
    Assert::IsTrue(
        pkbQueryInterface.modifies(setUpTests.w, setUpTests.underscore) ==
        STRING_SET{setUpTests.l3, setUpTests.l14, setUpTests.l17,
                   setUpTests.l23});
    Assert::IsTrue(
        pkbQueryInterface.modifies(setUpTests.c, setUpTests.underscore) ==
  ...
  TEST_METHOD(ModifiesStringAndVariable) {
    ...
    Assert::IsTrue(
        pkbQueryInterface.modifies(setUpTests.strpaux, setUpTests.variable) ==
        STRING_SET{"x", "y"}); // no calls, only vars modified directly
    Assert::IsTrue(
        pkbQueryInterface.modifies(setUpTests.strpmain, setUpTests.variable) ==
  ...
  TEST_METHOD(ModifiesStringAndUnderscore) {
    ...
    Assert::IsTrue(
        pkbQueryInterface.modifies(setUpTests.strpaux, setUpTests.underscore));
    Assert::IsTrue(
        pkbQueryInterface.modifies(setUpTests.strpmain, setUpTests.underscore));
    Assert::IsTrue(pkbQueryInterface.modifies(setUpTests.strpcomplicate,
  ...
  TEST_METHOD(ModifiesProcedureAndString) {
    ...
    Assert::IsTrue(
        pkbQueryInterface.modifies(setUpTests.procedure, setUpTests.strx) ==
        STRING_SET{"aux", "main"});
    Assert::IsTrue(
        pkbQueryInterface.modifies(setUpTests.procedure, setUpTests.strq) ==
  ...
  TEST_METHOD(ModifiesProcedureAndVariable) {
    ...
    Assert::IsTrue(
        pkbQueryInterface.modifies(setUpTests.procedure, setUpTests.variable) ==
        STRING_PAIRS(
  ...
  TEST_METHOD(ModifiesProcedureAndUnderscore) {
    ...
    Assert::IsTrue(pkbQueryInterface.modifies(setUpTests.procedure,
                                              setUpTests.underscore) ==
