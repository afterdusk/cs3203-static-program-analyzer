...
public:
  ...
  TEST_METHOD(FollowsLineNumberAndStatement) {
    ...
    // line number.
    Assert::IsTrue(pkbQueryInterface.follows(c1, r).value ==
                   StmtNumberList{"2"});
    Assert::IsTrue(pkbQueryInterface.follows(c2, w).value ==
                   StmtNumberList{"3"});
    Assert::IsTrue(pkbQueryInterface.follows(c3, p).value ==
                   StmtNumberList{"6"});
    Assert::IsTrue(pkbQueryInterface.follows(c4, r).value ==
                   StmtNumberList{"5"});
    Assert::IsTrue(pkbQueryInterface.follows(c7, r).value ==
                   StmtNumberList{"8"});
  ...
  TEST_METHOD(FollowsStatementAndLineNumber) {
    ...
    Assert::IsTrue(pkbQueryInterface.follows(r, c2).value ==
                   StmtNumberList{"1"});
    Assert::IsTrue(pkbQueryInterface.follows(a, c2).value == StmtNumberList());
    Assert::IsTrue(pkbQueryInterface.follows(r, c3).value ==
                   StmtNumberList{"2"});
    Assert::IsTrue(pkbQueryInterface.follows(w, c4).value == StmtNumberList());
    Assert::IsTrue(pkbQueryInterface.follows(a, c5).value ==
                   StmtNumberList{"4"});
    Assert::IsTrue(pkbQueryInterface.follows(w, c6).value ==
                   StmtNumberList{"3"});
    ...
    Assert::IsTrue(pkbQueryInterface.follows(c, c8).value ==
                   StmtNumberList{"7"});
