...
public:
  ...
  TEST_METHOD(ParentLineNumberAndUnderscore) {
    ...
    // Invalid parent
    Assert::IsFalse(setUpTests.pkbQueryInterface->parent(
        setUpTests.c16, setUpTests.underscore));
  } // namespace UnitTesting
    ...
    Assert::IsTrue(
        ...
        STRING_PAIRS(
            ...
            STRING_VECTOR{setUpTests.l16, setUpTests.l17, setUpTests.l19,
                          setUpTests.l22, setUpTests.l20, setUpTests.l21}));
  } // namespace UnitTesting
  ...
  TEST_METHOD(ParentStmtAndStatement) {
    ...
    Assert::IsTrue(
        ...
        STRING_PAIRS(
            ...
            STRING_VECTOR{setUpTests.l4, setUpTests.l24, setUpTests.l18,
  ...
  TEST_METHOD(ParentStmtAndStmt) {
    ...
    Assert::IsTrue(
        setUpTests.pkbQueryInterface->parent(setUpTests.stmt,
                                             setUpTests.stmt) ==
        STRING_PAIRS(
  ...
  TEST_METHOD(ParentStarLineNumberAndStatement) {
    ...
    Assert::IsTrue(
        ...
        STRING_SET()); // constant on assign
    Assert::IsTrue(setUpTests.pkbQueryInterface->parentStar(setUpTests.c21,
                                                            setUpTests.p) ==
                   STRING_SET()); // constant on print
    Assert::IsTrue(setUpTests.pkbQueryInterface->parentStar(setUpTests.c11,
                                                            setUpTests.c) ==
                   STRING_SET()); // constant on call
  }                               // namespace UnitTesting
  ...
  TEST_METHOD(ParentStarStatementAndLineNumber) {
    ...
    Assert::IsTrue(
        setUpTests.pkbQueryInterface->parentStar(setUpTests.w,
                                                 setUpTests.c18) ==
    ...
    Assert::IsTrue(setUpTests.pkbQueryInterface->parentStar(setUpTests.w,
                                                            setUpTests.c13) ==
                   STRING_SET()); // LineNumber does not belong in any container
  }                               // namespace UnitTesting
    ...
    Assert::IsTrue(
        ...
        STRING_PAIRS(
            ...
            STRING_VECTOR{setUpTests.l4, setUpTests.l24, setUpTests.l24,
                          setUpTests.l18, setUpTests.l18, setUpTests.l16,
                          setUpTests.l20}));
  } // namespace UnitTesting
